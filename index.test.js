...
const defaultResult = ['apple-touch-icon.105de2c5.png','icon-152x152.c0cccc53.webp','icon-152x152.c5e4d8cb.png','icon-192x192.3103561d.webp','icon-192x192.cab29cd7.png','icon-384x384.2b65be8b.png','icon-384x384.a54ab4a2.webp','icon-512x512.5c88cabb.webp','icon-512x512.b24e0d51.png','icon-96x96.00714ae7.webp','icon-96x96.b73322f2.png','mstile-150x150.df894f37.png','mstile-310x150.23817a3d.png','mstile-310x310.5f619e76.png','mstile-70x70.3bcf1bff.png'];
const testConfigs = [
  {
  ...
  },
  {
    ...
    result: [...defaultResult, 'favicon-16x16.726e3e17.png', 'favicon-32x32.6326f01e.png']
  }
];

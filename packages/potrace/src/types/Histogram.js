 ...
 * 1D Histogram
 *
 * @param {Number|Bitmap} imageSource - Image to collect pixel data from. Or integer to create empty histogram for image of specific size
 * @constructor
 * @protected
 */
function Histogram(imageSource) {
  this.data = null;
  this.pixels = 0;
